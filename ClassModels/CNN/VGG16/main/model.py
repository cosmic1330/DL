...
# 讀取資料－２
# training data path
trcloudy = './images/weatherImage/train/cloudy'
trrain = './images/weatherImage/train/rain'
trshine = './images/weatherImage/train/shine'
trsunrise = './images/weatherImage/train/sunrise'
# testing data path
testpath = './images/weatherImage/test'
...
my_callbacks = [
    ...
    ModelCheckpoint(
        filepath="./Models/CNN/VGG16/hw1_vision/myModel.h5", verbose=1,
        save_best_only=True),
...
plt.savefig('./Models/CNN/VGG16/hw1_vision/output.png',bbox_inches='tight')
plt.show()
cnn.save_weights('./Models/CNN/VGG16/hw1_vision/myModel_weights.h5')
...
test_label.to_csv('./Models/CNN/VGG16/hw1_vision/predict_label.csv',index=False)
